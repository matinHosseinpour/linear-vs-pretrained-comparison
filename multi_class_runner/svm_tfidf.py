...
from sklearn.feature_extraction.text import TfidfVectorizer  # Updated import
...
for file in files:
    ...
    vectorizer = TfidfVectorizer()  # Changed from CountVectorizer to TfidfVectorizer
    X = vectorizer.fit_transform(texts)
    y = np.array(labels)

    # 5. Define the SVM classifier
